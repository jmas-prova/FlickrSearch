...
import com.example.flickrsearch.Interfaces.OnDownloadComplete;
...
public class GetFlickrJsonData extends AsyncTask<String, Void, ArrayList<PhotoData>> implements OnDownloadComplete {
    ...
    public void onDownloadComplete(String data, DownloadStatus status) {
        if(status==DownloadStatus.OK){
            ...
            try{
                ...
                PhotoData photo= new PhotoData(author,authorID,title,description,dateTaken,published,tags,big_image_link,image);
